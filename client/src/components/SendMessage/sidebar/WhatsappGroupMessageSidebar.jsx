...
function WhatsappGroupMessageSidebar({
  ...
  return (
    <div
      className={`h-full flex flex-col ${isStandalone ? "w-72 bg-(--sidebar) border-r border-(--border)" : "w-full"}`}
    >
      {/* 📌 FIXED HEADER */}
      {isStandalone && (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4
                    className={`text-sm font-medium truncate ${selected ? "text-(--primary)" : "text-(--text-primary)"}`}
                  >
                    {g.name}
                  </h4>
