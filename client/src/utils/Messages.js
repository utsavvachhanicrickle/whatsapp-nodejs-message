export const MESSAGES = {
  // Message Sending
  SINGLE_MESSAGE_SUCCESS: "Message sent successfully!",
  SINGLE_MESSAGE_ERROR: "Failed to send message.",
  MULTIPLE_MESSAGE_SUCCESS: "Multiple messages sent successfully!",
  MULTIPLE_MESSAGE_ERROR: "Failed to send multiple messages.",
  GROUP_MESSAGE_SUCCESS: "Group messages sent successfully!",
  GROUP_MESSAGE_ERROR: "Failed to send group messages.",
